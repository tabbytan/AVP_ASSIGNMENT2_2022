...
public class Employees
{
    ...
    public Employees(string Nric, string FullName, string Salutation, string Start_Date, string Designation, string Department, string MobileNo, string HireType, double Salary)
    {
        this.Nric = Nric;
    ...
    public static List<Employees> readHRMasterList()
    {
        ...
        foreach (string line in allines)
        {
            ...
            Employees e = new Employees(item[0], item[1], item[2], item[3], item[4], item[5], item[6], item[7], double.Parse(item[8]));
            employeelist.Add(e);
        }
        return employeelist;
